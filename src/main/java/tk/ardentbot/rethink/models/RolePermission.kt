...
data class RolePermission(var id: String, var canUseArdentCommands: Boolean = true, var canSendLinks: Boolean = true,
                          var canSendDiscordInvites: Boolean = true, var rankable: Rankable?)
